...
class GetRSSSourceFeedUseCaseTestCase:
    ...
    def test_outcome(get_channel_patch, get_rss_list_patch, source_unseen_patch):
        ...
        assert data["unseen"] == [{'id': 1, 'title': 'test_title1', 'link': 'test_link1', 'description': 'test description1', 'source': {'id': 1}, 'pub_date': '2021-01-01'}, {'id': 2, 'title': 'test_title2', 'link': 'test_link2', 'description': 'test description2', 'source': {'id': 2}, 'pub_date': '2021-01-02'}]
