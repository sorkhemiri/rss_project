...
class RSSSourceListUseCaseTestCase:
    ...
    def test_outcome(rss_source_list_patch):
        ...
        assert data["rss_sources"] == [{'key': 'test_key1', 'title': 'test_title1', 'description': 'test_description1', 'link': 'test_link1'}, {'key': 'test_key2', 'title': 'test_title2', 'description': 'test_description2', 'link': 'test_link2'}]
